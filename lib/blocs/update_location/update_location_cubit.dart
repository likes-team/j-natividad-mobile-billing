...
class UpdateLocationCubit extends Cubit<UpdateLocationState> {
  ...
  UpdateLocationCubit({required DeliveryRepository deliveryRepository, required DeliveriesCubit deliveryCubit}) : 
    _deliveryRepository = deliveryRepository,
    _deliveryCubit = deliveryCubit,
    super(UpdateLocationState());


  Future<void> updateLocation({required Delivery delivery, required UserLocation userLocation}) async {
    emit(state.copyWith(
