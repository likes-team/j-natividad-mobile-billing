...
class DeliveryRepository {
  ...
  Future<dynamic> deliver({required Delivery delivery, required File image, required UserLocation userLocation}) async{
    final User currentUser = await UserService.getUser();
  ...
  Future<dynamic> redeliver({required FailedDelivery failedDelivery}) async{
    final User currentUser = await UserService.getUser();
