...
import 'package:jnb_mobile/components/delivery_tile_component.dart';
import 'package:jnb_mobile/components/qr_scanner_modal.dart';
  ...
  Widget build(BuildContext context) {
    return MultiBlocListener(
      listeners: [
        ...
        BlocListener<DeliveriesCubit, DeliveryState>(
...
class InProgressTab extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final DeliveriesCubit _deliveryCubit = BlocProvider.of<DeliveriesCubit>(context);
